...
class MonitoreoComentario
{
    ...
    /**
     * MonitoreoComentario constructor.
     */
    ...
    public function obtener_id()
    {
        ...
        $this->id_comentario = $this->c_conectar->get_valor_query($query, "codigo");
    }
    ...
    {
        $query = "delete from monitoreo_comentarios 
        where id_comentario = '".$this->id_comentario."' and id_monitoreos = '".$this->id_monitoreo."'";
