...
$planResiduo->setIdCliente($_SESSION['id_cliente']);
$planResiduo->setAnio(date("Y"));

$listaSucursales=$planResiduo->versucursalesAnio();
...
<script>
    function ir_monitoreo(id) {
        ...
        location.href = "ver_planes_residuos.php?sucursal=" + id + "&anio=" + anio;
    }
