...
<html lang="es">
    ...
    <head>
        ...
        <title>Acceso Clientes - SEAQ SAC - Software de Gestion</title>
        <!-- plugins:css -->
                        ...
                        <div class="col-lg-4 mx-auto">
                            <div class="auto-form-wrapper">
                                <form action="controller/login.php" method="post">
                                    ...
                                    <?php } ?>
                                    <div class="form-group">
                                        <label class="label">RUC Empresa</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="RUC" name="input_ruc">
