...
// = filter_input(INPUT_POST, 'input_ccsucursal');
$filename = "../../archivos/cotizaciones/" . $archivo;
//echo "../upload/".$ccliente."/".$csucursal."/cotizacion/" . $archivo;

$pdfdoc = file_get_contents($filename);
$attachment = chunk_split(base64_encode($pdfdoc));

$email_from = 'ventas@seaqsac.com';
$headers = "From: \"Area de Ventas - SEAQ SAC \"<" . $email_from . ">" . $eol;

$headers .= "MIME-Version: 1.0" . $eol;
$headers .= "Reply-To: kgarcia@seaqsac.com" . $eol;
$headers .= "Bcc: kgarcia@seaqsac.com" . $eol;
...
if (!$error_ocurred) {
    ...
    ?>
    <script>
       // window.location.href = "../ver_presupuestos.php";
    </script>
    <?php
