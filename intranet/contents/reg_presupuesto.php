...
<head>
    ...
    <title>Agregar Presupuesto | SEAQ SAC - Software de Gestion </title>
    <!-- plugins:css -->
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <form class="form-sample" enctype="multipart/form-data" method="post"
                                  action="../controller/reg_presupuesto.php">
                                <div class="card-header">
                                    <h4 class="h3">Agregar Presupuesto</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="input_descripcion"
                                                   name="input_descripcion" required/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input accept="application/pdf" id="seletarchivo" type="file" name="input_archivo" class="file-upload-default">
                                            <div class="input-group col-xs-12">
                                                ...
                                                <span class="input-group-append">
                                                    <button onclick="selectArchivo()" class="file-upload-browse btn btn-info"
                                                            type="button"><i class="fa fa-cloud-upload"></i>Seleccione</button>
                                                  </span>
                                            </div>
                                            <!--input type="file" class="form-control" id="input_archivo"
                                                   name="input_archivo" accept="application/pdf" required/-->
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Codigo</label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="input_codigo" required/>
                                        </div>
                                    </div>
...
<script>
    ...
    function selectArchivo() {
        $('#seletarchivo').trigger('click');
    }
    $('#seletarchivo').on('change', function() {
