...
values ('" . $this->id_cliente . "', '" . $this->ruc . "', '" . $this->razon_social . "', '" . $this->direccion . "', '" . $this->contacto . "', '" . $this->email . "', '" . $this->celular . "', '" . $this->cargo . "', '" . $this->tipo . "', '" . $this->id_empresa . "', '0000-00-00', '1', '" . $this->contrasena . "', '" . $this->logo . "')";
        return cl_conectar::ejecutar_idu($query);
    }
